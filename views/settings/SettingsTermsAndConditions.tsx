...
import { modalViewBase, viewDashboardBase } from "../../theme/elements";
		...
		<View style={viewDashboardBase}>
			...
			<View style={{ flex: 1, padding: 10 }}>
				<View style={styles.headerView}>
					<Text h1 style={{ color: colors.white, marginBottom: 0 }}>Terms and conditions</Text>
				</View>
				<View>
					<SettingsListItem
				...
				{visible && (
					<Modal visible={visible}>
						<View style={{ ...modalViewBase, height: '100%'}}>
							<ModalHeader
								rightComponent={<CancelBtn onClick={() => {
									setUseHeader(false);
									setVisible(false);
								}} />}
							/>
