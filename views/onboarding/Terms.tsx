...
import { Terms as TermsType } from "../../utils/types";
import { useUserDetails } from "../../hooks/useUserDetails";

type TermsState = TermsType;
...
const TermsView = (props: TermsProps) => {
	...
	const documents: {[index: string]:any} = useMemo(() => ({
		terms: (<WebView style={{ backgroundColor: 'transparent' }} source={require('../../assets/document.pdf')} />),
		privacy: (<WebView style={{ backgroundColor: 'transparent' }} source={require('../../assets/document.pdf')} />),
		banking: (<WebView style={{ backgroundColor: 'transparent' }} source={require('../../assets/document.pdf')} />)
	}), []);
		...
		<View style={{...viewBase}}>
			...
			<View style={wrappingContainerBase}>
				...
				<View style={styles.termsView}>
					<TouchableWithoutFeedback onPress={() => { setVisible(true); setViewType(views.terms); }}>
						<View style={styles.termsItem}>
							<View style={styles.termsTextWrap}>
								<Text style={styles.termsText}>Terms and Conditions</Text>
							</View>
							<View style={[styles.circle, (termsState.terms ? styles.circleSelected : {})]}>
								<MaterialIcons name="done" style={styles.icon}/>
							</View>
						</View>
					</TouchableWithoutFeedback>
					<TouchableWithoutFeedback onPress={() => { setVisible(true); setViewType(views.privacy); }}>
						<View style={styles.termsItem}>
							<View style={styles.termsTextWrap}>
								<Text style={styles.termsText}>Privacy Policy</Text>
							</View>
							<View style={[styles.circle, (termsState.privacy ? styles.circleSelected : {})]}>
								<MaterialIcons name="done" style={styles.icon}/>
							</View>
						</View>
					</TouchableWithoutFeedback>
					<TouchableWithoutFeedback onPress={() => { setVisible(true); setViewType(views.banking); }}>
						<View style={styles.termsItem}>
							<View style={styles.termsTextWrap}>
								<Text style={styles.termsText}>Liendhardt banking account Terms and Conditions</Text>
							</View>
							<View style={[styles.circle, (termsState.banking ? styles.circleSelected : {})]}>
								<MaterialIcons name="done" style={styles.icon}/>
							</View>
						</View>
					</TouchableWithoutFeedback>
