...
function PrimaryStackScreen() {
	return (
		...
		>
			...
			<PrimaryStack.Screen name="MarketEntryDetails" component={MarketEntryDetails}/>
			...
			<PrimaryStack.Screen name="SettingsHelpAndContact" component={SettingsHelpAndContact}/>
			...
			<PrimaryStack.Screen name="SettingsPersonalDetails" component={SettingsPersonalDetails}/>
			<PrimaryStack.Screen name="SettingsAccountDetails" component={SettingsAccountDetails}/>
