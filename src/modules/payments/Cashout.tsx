...
const CashoutAmount = (props: CashOutInput): JSX.Element => {
	...
	const styles = userType === UserType.Business ? BusinessCashOut : CustomerCashOut;
		...
		<KeyboardAvoidingView
			...
			<ScrollView style={wrappingContainerBase}>
				...
				<View>
					...
					{exceed && <Text style={styles.errorBalance}>
						{walletData?.availableBalance <= 5 ? Translation.PAYMENT.PERSONAL_EXCEED_BALANCE : Translation.PAYMENT.PERSONAL_EXCEED_$5}
					</Text>}
			...
			<SafeAreaView style={styles.bottomView}>
				<Button
					...
					disabled={!goNext
						|| exceed
						|| (userType === UserType.Customer && walletData?.availableBalance > 5)
						|| !walletData
						|| !userId}
