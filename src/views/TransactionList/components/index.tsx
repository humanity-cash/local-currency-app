...
export const TransactionItem = (props: MyTransactionItemProps) => {
	...
	return (
		<View style={selected === item.transactionHash ? mListstyles.selectedItem : mListstyles.item}>
			<View style={mListstyles.imageContainer}>
				...
				<View>
					<Text>{name}</Text>
					<Text style={mListstyles.timeText}>{moment(item.timestamp).format('HH:mm, MMM D, YYYY')}</Text>
