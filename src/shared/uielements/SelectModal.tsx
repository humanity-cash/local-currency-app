  ...
  return (
    <View>
      <TouchableOpacity onPress={() => setVisible(true)}>
        ...
        >
          {selected?.icon && (
            <Image source={selected?.icon} containerStyle={styles.flagImage} />
          )}
          {!selected.icon && (
          ...
          <View>
            ...
            <ScrollView style={{ padding: 10, height: "100%" }}>
              ...
              {modalMainOption && (
                <TouchableOpacity
                  onPress={() =>
                    modalMainOption && onOptionSelect(modalMainOption)
                  }
                >
                  <View style={styles.modalMainItemView}>
                    {modalMainOption?.icon && (
                      <Image
                        source={modalMainOption?.icon}
                        containerStyle={styles.flagImage}
                      />
                    )}
                    {!modalMainOption.icon && (
                      <Image source={{}} containerStyle={styles.flagNoImage} />
