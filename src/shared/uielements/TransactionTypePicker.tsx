...
const TransactionTypePicker = ({
	...
	return (
		<View style={{...styles.container, ...style, borderColor: isOpen ? colors.purple : 'transparent'}}>
			<TouchableOpacity
				onPress={() => {
					setIsOpen(!isOpen)
				}}
			>
				<View style={{flexDirection: 'row', alignItems: 'center'}}>
					<Text style={[styles.selectedText, {opacity: typeText.length > 0 ? 1 : 0.4}]} numberOfLines={1}>
