...
const DwollaDialog = (props: DwollaDialogProps): JSX.Element => {
    ...
    const mainTextStyle = {color: colors.purple};
    ...
    return (
        <Dialog 
            ...
            style={styles.dialog} 
            backgroundStyle={styles.bDialogBg}
        >
            <View style={dialogViewBase}>
                <View style={styles.dialogWrap}>
                    <Text style={styles.dialogHeaderB}>BerkShares uses Dwolla to link your business bank account.</Text>
