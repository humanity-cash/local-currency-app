...
import MerchantDictionary from "./whereToSpend";
  ...
  return (
    <View style={styles.drawerWrap}>
      <DrawerContentScrollView {...props}>
        <View>
          ...
          <View style={styles.infoView}>
            <TouchableWithoutFeedback
              onPress={() => (!businessTag ? null : setIsExpanded(!isExpanded))}
            >
            ...
            {isExpanded && (
              <View>
                <TouchableWithoutFeedback
                  onPress={() => (businessTag ? onMerchant() : null)}
                >
                  {businessTag ? (
                    <View style={styles.userInfo}>
                      <View style={styles.imageView}>
                ...
                {authorization.cashierView ? (
                  <TouchableWithoutFeedback
                    onPress={() => (businessTag ? onCashier() : null)}
                  >
                    {businessTag ? (
                      <View style={styles.userInfo}>
                        <View style={styles.imageView}>
          ...
          <Text style={styles.berkAmount}>
            B$ {customerWalletData?.availableBalance?.toFixed(2)}
          </Text>
          <Drawer.Section>
            <DrawerItem
          ...
          <Drawer.Section>
            <DrawerItem
              ...
              onPress={() => {
                props.navigation.navigate(Routes.MY_TRANSACTIONS);
              }}
            />
            <DrawerItem
              label="Where to spend"
              onPress={() => {
                props.navigation.navigate(Routes.WHERE_TO_SPEND);
              }}
            />
            {!user?.verifiedBusiness && (
              <DrawerItem
                ...
                onPress={() => {
                  props.navigation.navigate(Routes.BUSINESS_ACCOUNT);
                }}
              />
            )}
            <DrawerItem
      ...
      <Drawer.Section style={styles.bottomSection}>
        <DrawerItem
          icon={() => <Feather name="log-out" size={24} color={colors.text} />}
          label="Sign out"
          onPress={() => {
            signOut();
          }}
