...
import BusinessTransactionsFilter from "./BusinessTransactionsFilter";
	...
	const onPressScan = async () => {
		...
		if(status === 'granted') {
			if(businessFundingSource && businessWallet.availableBalance > 0) {
				...
				navigation.navigate(Routes.BUSINESS_REQUEST)
			}
		} else {
			setIsSetting(true)
		}
			...
			<View style={wrappingContainerBase}>
				...
				<ScrollView>
					<View style={styles.content}>
						...
						{isFilterVisible && <BusinessTransactionsFilter></BusinessTransactionsFilter>}
						<BusinessTransactionList data={businessTransactions} onSelect={viewDetail} />
					</View>
				</ScrollView>
			</View>
			<SafeAreaView>
