...
const BusinessCashoutAmount = (): JSX.Element => {
	...
	return (
		<View style={viewBaseB}>
			<Header
				...
				rightComponent={<CancelBtn text={Translation.BUTTON.CLOSE} color={colors.purple} onClick={() => navigation.navigate(Routes.BUSINESS_DASHBOARD)} />}
			/>
			...
			<KeyboardAvoidingView
				...
				<View style={styles.bottomView}>
					<Button
						...
						onPress={()=>navigation.navigate(Routes.BUSINESS_PAYOUT_PENDING)}
					/>
				</View>
			</KeyboardAvoidingView>
		</View>
...
export default BusinessCashoutAmount