...
export const BusinessSettingsBankAccount = (): ReactElement => {
				...
				}
				{
					!hasBankAccount && (
						<Button
							...
							onPress={()=>navigation.navigate(Routes.BUSINESS_BANK_ACCOUNT)}
						/>
					)
				}
			</View>
...
export default BusinessSettingsBankAccount;