...
export const BusinessSettings = (): JSX.Element => {
			...
			<ScrollView style={styles.container}>
				...
				<View style={styles.settingsView}>
					<Button
						...
						onPress={()=>navigation.navigate(Routes.BUSINESS_SETTINGS_PROFILE)}
					/>
					<Button
						type={BUTTON_TYPES.TRANSPARENT}
						...
						style={styles.settingItem}
						textStyle={styles.btnText}
						onPress={()=>navigation.navigate(Routes.BUSINESS_SETTINGS_BANK_ACCOUNT)}
					/>
					<Button
						type={BUTTON_TYPES.TRANSPARENT}
						...
						style={styles.settingItem}
						textStyle={styles.btnText}
						onPress={()=>navigation.navigate(Routes.BUSINESS_SETTINGS_STATIC_QR)}
					/>
					<Button
						type={BUTTON_TYPES.TRANSPARENT}
						...
						style={styles.settingItem}
						textStyle={styles.btnText}
						onPress={()=>navigation.navigate(Routes.BUSINESS_SETTINGS_LEGAL)}
					/>
					<Button
						type={BUTTON_TYPES.TRANSPARENT}
						...
						style={styles.settingItem}
						textStyle={styles.btnText}
						onPress={()=>navigation.navigate(Routes.BUSINESS_SETTINGS_SECURITY)}
					/>
				</View>
			</ScrollView>
