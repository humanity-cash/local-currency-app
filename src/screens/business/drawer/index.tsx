...
const DrawerContent = (props: DrawerContentComponentProps) => {
	...
	const onPressLoadup = async () => {
		if (businessWalletData?.address && businessFundingSource) {
			props.navigation.navigate(Routes.LOAD_UP, { userId: businessDwollaId, styles: 'business' })
		} else {
			setBankDialogState({
				visible: true,
				title: Translation.LOAD_UP.LOAD_UP_NO_BANK_TITLE,
...
const MerchantTabs: React.FC = () => {
	return (
		<DrawerNav.Navigator initialRouteName={Routes.MERCHANT_DASHBOARD} drawerContent={props => <DrawerContent {...props} />}>
			...
			<DrawerNav.Screen name={Routes.MERCHANT_CASHOUT_AMOUNT} component={PaymentsModule.Cashout} />
			<DrawerNav.Screen name={Routes.MERCHANT_LOADUP} component={PaymentsModule.Loadup} />
