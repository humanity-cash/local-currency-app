...
export const NavigationProvider: React.FunctionComponent = ({ children }) => {
	const [selectedView, setSelectedView] = useState<ViewState>(ViewState.Onboarding);
	...
	return (
		<NavigationViewContext.Provider value={state}>{children}</NavigationViewContext.Provider>
	);
};
